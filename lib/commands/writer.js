 ...
 * @api public
 */
var _execute = function(templateDir, outputPath, callback, bootstrapVars, replaceAll){
    _vars = {};
    _callback = callback;
    _currentIndex = 0;
...
var _initConfigModel = function(templateDir, vars, depInfo){
    Config = new Config(templateDir, vars, depInfo, function(err, dirs, files, vars){
        _vars = vars;
